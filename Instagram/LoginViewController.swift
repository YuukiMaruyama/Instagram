...
class LoginViewController: UIViewController {
    ...
    @IBAction func handleLoginButton(_ sender: Any) {
        if let address = mailAddressTextField.text, let password = passwordTexiField.text {
    ...
    @IBAction func handleCreateAccountButton(_ sender: Any) {
        if let address = mailAddressTextField.text, let password = passwordTexiField.text, let displayName = displayNameTextField.text {
